...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] =   (a[1] * b[2]) - (b[1] * a[2]); // v3[0] =   (a[1] * b[2]) - (a[2] * b[1]);
        v3.elements[1] = 0 - ((a[0] * b[2]) - (b[0] * a[2])); // v3[1] = -((a[0] * b[2]) - (a[2] * b[0]));
        v3.elements[2] =   (a[0] * b[1]) - (b[0] * a[1]); // v3[2] =   (a[0] * b[1]) - (a[1] * b[0]);
        // Don't delete the return statement.
        return v3;
    }
